 ...
 */
abstract class Part implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\app\\model\\Map\\PartTableMap';
    ...
    /**
     * Initializes internal state of app\model\Base\Part object.
     */
    ...
    /**
     * Compares this with another <code>Part</code> instance.  If
     * <code>obj</code> is an instance of <code>Part</code>, delegates to
     * <code>equals(Part)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Part The current object, for fluid interface
     */
     ...
     * @return $this|\app\model\Part The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PartTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[PartTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PartTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PartTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = PartTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\app\\model\\Part'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPartQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPartQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PartTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[PartTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . PartTableMap::COL_ID . ')');
        }
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('part_id_seq')");
        ...
        if ($this->isColumnModified(PartTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(PartTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO part (%s) VALUES (%s)',
    ...
    {
        $pos = PartTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Part'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Part'][$this->hashCode()] = true;
        $keys = PartTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\app\model\Part The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(PartTableMap::DATABASE_NAME);

        if ($this->isColumnModified(PartTableMap::COL_ID)) {
            $criteria->add(PartTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(PartTableMap::COL_NAME)) {
            $criteria->add(PartTableMap::COL_NAME, $this->name);
        }
    ...
    {
        $criteria = ChildPartQuery::create();
        $criteria->add(PartTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \app\model\Part (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \app\model\Part Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildPart is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildPart The current object (for fluent API support)
     */
     ...
     * @return ObjectCollection|ChildItem[] List of ChildItem objects
     */
    public function getItemsJoinProprium(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildItemQuery::create(null, $criteria);
        $query->joinWith('Proprium', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(PartTableMap::DEFAULT_STRING_FORMAT);
    }
