...
/**
 * Base class that represents a row from the 'player_battle_log' table.
 *
 *
 *
 * @package    propel.generator.app.model.Base
 */
abstract class PlayerBattleLog implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\app\\model\\Map\\PlayerBattleLogTableMap';
    ...
    /**
     * The value for the enemy_player_id field.
     *
     * @var        int
     */
     ...
     * @var        ChildPlayer
     */
    protected $aPlayerRelatedByEnemyPlayerId;
    ...
    /**
     * Initializes internal state of app\model\Base\PlayerBattleLog object.
     */
    ...
    /**
     * Compares this with another <code>PlayerBattleLog</code> instance.  If
     * <code>obj</code> is an instance of <code>PlayerBattleLog</code>, delegates to
     * <code>equals(PlayerBattleLog)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PlayerBattleLog The current object, for fluid interface
     */
    ...
    /**
     * Get the [enemy_player_id] column value.
     *
     * @return int
     */
    public function getEnemyPlayerId()
    {
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PlayerBattleLogTableMap::COL_ID] = true;
        }
    ...
    public function setPlayerId($v)
    {
        ...
        if ($this->player_id !== $v) {
            $this->player_id = $v;
            $this->modifiedColumns[PlayerBattleLogTableMap::COL_PLAYER_ID] = true;
        }
    ...
    /**
     * Set the value of [enemy_player_id] column.
     *
     * @param int $v new value
     * @return $this|\app\model\PlayerBattleLog The current object (for fluent API support)
     */
    public function setEnemyPlayerId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->enemy_player_id !== $v) {
            $this->enemy_player_id = $v;
            $this->modifiedColumns[PlayerBattleLogTableMap::COL_ENEMY_PLAYER_ID] = true;
        }

        if ($this->aPlayerRelatedByEnemyPlayerId !== null && $this->aPlayerRelatedByEnemyPlayerId->getId() !== $v) {
            $this->aPlayerRelatedByEnemyPlayerId = null;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PlayerBattleLogTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PlayerBattleLogTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PlayerBattleLogTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PlayerBattleLogTableMap::translateFieldName('PlayerId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPlayerRelatedByEnemyPlayerId !== null && $this->enemy_player_id !== $this->aPlayerRelatedByEnemyPlayerId->getId()) {
            $this->aPlayerRelatedByEnemyPlayerId = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPlayerBattleLogQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PlayerBattleLog::setDeleted()
     * @see PlayerBattleLog::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPlayerBattleLogQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PlayerBattleLogTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(\Propel\Runtime\Util\PropelDateTime::createHighPrecision());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PlayerBattleLogTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(\Propel\Runtime\Util\PropelDateTime::createHighPrecision());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PlayerBattleLogTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aPlayerRelatedByEnemyPlayerId !== null) {
                if ($this->aPlayerRelatedByEnemyPlayerId->isModified() || $this->aPlayerRelatedByEnemyPlayerId->isNew()) {
                    $affectedRows += $this->aPlayerRelatedByEnemyPlayerId->save($con);
                }
                $this->setPlayerRelatedByEnemyPlayerId($this->aPlayerRelatedByEnemyPlayerId);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('player_battle_log_id_seq')");
        ...
        if ($this->isColumnModified(PlayerBattleLogTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(PlayerBattleLogTableMap::COL_PLAYER_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO player_battle_log (%s) VALUES (%s)',
    ...
    {
        $pos = PlayerBattleLogTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PlayerBattleLog'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PlayerBattleLog'][$this->hashCode()] = true;
        $keys = PlayerBattleLogTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aPlayerRelatedByEnemyPlayerId) {
                ...
                $result[$key] = $this->aPlayerRelatedByEnemyPlayerId->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\app\model\PlayerBattleLog
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\app\model\PlayerBattleLog The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PlayerBattleLogTableMap::COL_ID)) {
            $criteria->add(PlayerBattleLogTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(PlayerBattleLogTableMap::COL_PLAYER_ID)) {
            $criteria->add(PlayerBattleLogTableMap::COL_PLAYER_ID, $this->player_id);
        }
        if ($this->isColumnModified(PlayerBattleLogTableMap::COL_ENEMY_PLAYER_ID)) {
        ...
        if ($this->isColumnModified(PlayerBattleLogTableMap::COL_UPDATED_AT)) {
            $criteria->add(PlayerBattleLogTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildPlayerBattleLogQuery::create();
        $criteria->add(PlayerBattleLogTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \app\model\PlayerBattleLog (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \app\model\PlayerBattleLog Clone of current object.
     * @throws PropelException
     */
    ...
    public function setPlayerRelatedByPlayerId(ChildPlayer $v = null)
    {
        ...
        if ($v !== null) {
            $v->addPlayerBattleLogRelatedByPlayerId($this);
        }
    ...
    public function getPlayerRelatedByPlayerId(ConnectionInterface $con = null)
    {
        if ($this->aPlayerRelatedByPlayerId === null && ($this->player_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPlayerRelatedByPlayerId->addPlayerBattleLogsRelatedByPlayerId($this);
             */
        }
     ...
     * @throws PropelException
     */
    public function setPlayerRelatedByEnemyPlayerId(ChildPlayer $v = null)
    {
        if ($v === null) {
            $this->setEnemyPlayerId(NULL);
        } else {
            $this->setEnemyPlayerId($v->getId());
        }

        $this->aPlayerRelatedByEnemyPlayerId = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildPlayer object, it will not be re-added.
        if ($v !== null) {
            $v->addPlayerBattleLogRelatedByEnemyPlayerId($this);
        }
     ...
     * @throws PropelException
     */
    public function getPlayerRelatedByEnemyPlayerId(ConnectionInterface $con = null)
    {
        if ($this->aPlayerRelatedByEnemyPlayerId === null && ($this->enemy_player_id !== null)) {
            $this->aPlayerRelatedByEnemyPlayerId = ChildPlayerQuery::create()->findPk($this->enemy_player_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPlayerRelatedByEnemyPlayerId->addPlayerBattleLogsRelatedByEnemyPlayerId($this);
             */
        }

        return $this->aPlayerRelatedByEnemyPlayerId;
    }
    ...
    {
        if (null !== $this->aPlayerRelatedByPlayerId) {
            $this->aPlayerRelatedByPlayerId->removePlayerBattleLogRelatedByPlayerId($this);
        }
        if (null !== $this->aPlayerRelatedByEnemyPlayerId) {
            $this->aPlayerRelatedByEnemyPlayerId->removePlayerBattleLogRelatedByEnemyPlayerId($this);
        }
        $this->id = null;
        $this->player_id = null;
    ...
    {
        return (string) $this->exportTo(PlayerBattleLogTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildPlayerBattleLog The current object (for fluent API support)
     */
